...
U_TD_KOV,              KC_AT,             KC_HASH,           KC_AMPR,           U_NA,               U_NA,              U_NP,   	          U_NP,             U_NP,     	       U_NP,  	          \
...
U_NP,              U_NP,              KC_TILDE,          KC_MINS,           KC_UNDS,           U_NA,              U_NP,              U_NP,              U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV_VI \
U_NP,              U_NP,              U_NP,  	         U_NP,  	        U_NA,              KC_MUTE,           KC_VOLD,           KC_VOLU,           U_NP,              U_NP,              \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           CW_TOGG,           \
U_NA,              KC_ALGR,           KC_BTN2,    	     KC_BTN1,           KC_ESC,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            U_NP,              \
...
U_NP,              U_NP,              U_NP,  	         U_NP,  	        U_NA,              KC_GT,             KC_RPRN,           KC_RCBR,           KC_RBRC,           U_NP,             \
